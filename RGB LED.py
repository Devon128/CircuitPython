...
class RGB:
    ...
    def Blinky(self, rate, brightness=65535):
        for i in range(25):
            self.myBlueLED.on(min(max((brightness-random.randint(0, 65535)), 0), 65535))
            self.myGreenLED.on(min(max((brightness-random.randint(0, 65535)), 0), 65535))
            self.myRedLED.on(min(max((brightness-random.randint(0, 65535)), 0), 65535))
            time.sleep(rate/100)
            self.myBlueLED.off()
            self.myGreenLED.off()
            self.myRedLED.off()
